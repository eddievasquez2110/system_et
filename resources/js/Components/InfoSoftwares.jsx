    ...
    return (
        <div className='flex flex-row place-content-center pb-5'>
            <div className=''>
                ...
                <a href={`${infoSoftware.Link_Software}`} className="flex flex- items-center bg-white border-2 border-green-300 rounded-lg md:flex-row md:max-w-xl md:h-48 hover:bg-gray-100 ">
                    <img src={`../images/softwares/${infoSoftware.ID_Software}.png`} className="object-cover w-40 h-33 rounded-t-lg md:h-40 md:w-48 md:rounded-none md:rounded-l-lg" alt="#" />
