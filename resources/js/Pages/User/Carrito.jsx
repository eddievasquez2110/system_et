                        ...
                        <div className='p-3 space-y-5'>
                          ...
                          <div className="mb-4">
                            ...
                            <input
                                ...
                                name="proyecto"
                                onChange={(e) =>
                                    {setData("Proyecto", e.target.files[0]);
                                    onSelectedFile(e)}
                                }
                            />
                            </label>
                            ...
                            <div className="w-full bg-gray-200 rounded-full dark:bg-gray-700">
                              <div className="bg-green-600 text-xs font-medium text-green-100 text-center p-0.5 leading-none rounded-full" width={progress.percentage}> {progress.percentage}%</div>
                            </div>
                            )}
                            {preview && <embed className='pt-3' src={`${preview}`} alt="" style={{width:'380px'}}  /> }
