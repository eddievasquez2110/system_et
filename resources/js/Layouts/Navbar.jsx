        ...
        <div className="min-h-screen shadow-md bg-green-800 relative" style={open ?{width:'18%'}:{width:'75px'}}>
            ...
            <div className="overflow-y-auto py-4">
                <ul className="space-y-2">
                    <li className='px-3'>
                        <a href="#" onClick={()=>setShow(false)} className="flex items-center justify-center p-2 text-base font-normal text-white rounded-lg   hover:text-blue-600 hover:bg-blue-50 focus:bg-blue-50 focus:text-blue-600 transition duration-300 ease-in-out">
                    ...
                    <li className='px-3'>
                        <button href="#" onClick={()=>setShow(!show)} className="flex items-center justify-center w-full p-2 text-base font-normal text-white rounded-lg  hover:text-blue-600 hover:bg-blue-50 focus:bg-blue-50 focus:text-blue-600 transition duration-300 ease-in-out">
                        ...
                        <ul style={show?{display:"block"}:{display:"none"}} className="bg-white rounded-lg mt-1">
                            <li>
                            <a href="#" className="flex items-center p-2 pl-11 w-full text-sm font-normal  rounded-lg hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out">Tipo de Equipo</a>
                            </li>
                            <li>
                    ...
                    <li className='px-3'>
                        <a href="#" onClick={()=>setShow(false)} className="flex items-center  justify-center p-2 text-base font-normal text-white rounded-lg  text-gray-700 rounded-lg  hover:text-blue-600 hover:bg-blue-50 focus:bg-blue-50 focus:text-blue-600 transition duration-300 ease-in-out">
